...
print('small')
experiment([20, 1], 'sigmoid', 'random_normal', 4000, 'bank_results/small/rand_sig')
experiment([20, 1], 'relu', 'random_normal', 4000, 'bank_results/small/rand_relu')
experiment([20, 1], 'sigmoid', 'glorot_normal', 4000, 'bank_results/small/xavier')
experiment([20, 1], 'relu', 'he_normal', 4000, 'bank_results/small/he')

print('medium')
experiment([30, 1], 'sigmoid', 'random_normal', 5000, 'bank_results/medium/rand_sig')
experiment([30, 1], 'relu', 'random_normal', 5000, 'bank_results/medium/rand_relu')
experiment([30, 1], 'sigmoid', 'glorot_normal', 5000, 'bank_results/medium/xavier')
experiment([30, 1], 'relu', 'he_normal', 5000, 'bank_results/medium/he')

print('large')
experiment([30, 10, 1], 'sigmoid', 'random_normal', 1000, 'bank_results/large/rand_sig')
experiment([30, 10, 1], 'relu', 'random_normal', 1000, 'bank_results/large/rand_relu')
experiment([30, 10, 1], 'sigmoid', 'glorot_normal', 1000, 'bank_results/large/xavier')
experiment([30, 10, 1], 'relu', 'he_normal', 1000, 'bank_results/large/he')
